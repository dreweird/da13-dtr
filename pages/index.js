    ...
    <Layout className="" metaInfo={metaInfo}>
      ...
      <div className="grid gap-x-2 gap-y-4 grid-cols-2">
        <div className="w-full">
          ...
          <thead>
            <tr className="border-2 border-black text-sm">
              <td rowSpan={0} style={{ width: '15px' }} className="border-2 border-black text-sm"></td>
              <td rowSpan={4} style={{ width: '5px' }} className="border-2 border-black text-sm text-center">
                {selectedDays === '1-15' && time && time[0]?.All_Total_1_to_15}
                {selectedDays === '16-31' && time && time[0]?.All_Total_16_to_31}
                {selectedDays === 'All' && time && time[0]?.All_Total_1_to_31} Minutes
              </td>
            </tr>
          </thead>
        </table>
